...
const searchbox3 = document.querySelector(".input-container3 input");
const searchbtn3 = document.querySelector(".input-container3 button");
...
async function getlatlon(city) {
  ...
  if (currentWeather.status == 404) {
    ...
    async function getforecast() {
      ...
      document.querySelector(".forecast1:nth-child(1) .date").innerHTML =
        getDate(forecastdata.list[0].dt, timezone).substring(0, 10);

      document.querySelector(".forecast1:nth-child(1) .time").innerHTML =
        getTime(forecastdata.list[0].dt, timezone);
      ...
      document.querySelector(".forecast1:nth-child(2) .date").innerHTML =
        getDate(forecastdata.list[1].dt, timezone).substring(0, 10);

      document.querySelector(".forecast1:nth-child(2) .time").innerHTML =
        getTime(forecastdata.list[1].dt, timezone);
      ...
      document.querySelector(".forecast1:nth-child(3) .date").innerHTML =
        getDate(forecastdata.list[2].dt, timezone).substring(0, 10);

      document.querySelector(".forecast1:nth-child(3) .time").innerHTML =
        getTime(forecastdata.list[2].dt, timezone);
      ...
      document.querySelector(".forecast1:nth-child(4) .date").innerHTML =
        getDate(forecastdata.list[3].dt, timezone).substring(0, 10);

      document.querySelector(".forecast1:nth-child(4) .time").innerHTML =
        getTime(forecastdata.list[3].dt, timezone);
      ...
      document.querySelector(".forecast1:nth-child(5) .date").innerHTML =
        getDate(forecastdata.list[4].dt, timezone).substring(0, 10);

      document.querySelector(".forecast1:nth-child(5) .time").innerHTML =
        getTime(forecastdata.list[4].dt, timezone);
      ...
      document.querySelector(".forecast1:nth-child(6) .date").innerHTML =
        getDate(forecastdata.list[5].dt, timezone).substring(0, 10);

      document.querySelector(".forecast1:nth-child(6) .time").innerHTML =
        getTime(forecastdata.list[5].dt, timezone);
      ...
      document.querySelector(".forecast1:nth-child(7) .date").innerHTML =
        getDate(forecastdata.list[6].dt, timezone).substring(0, 10);

      document.querySelector(".forecast1:nth-child(7) .time").innerHTML =
        getTime(forecastdata.list[6].dt, timezone);
      ...
      document.querySelector(".forecast1:nth-child(8) .date").innerHTML =
        getDate(forecastdata.list[7].dt, timezone).substring(0, 10);

      document.querySelector(".forecast1:nth-child(8) .time").innerHTML =
        getTime(forecastdata.list[7].dt, timezone);
      ...
      document.querySelector(".forecast1:nth-child(9) .date").innerHTML =
        getDate(forecastdata.list[8].dt, timezone).substring(0, 10);

      document.querySelector(".forecast1:nth-child(9) .time").innerHTML =
        getTime(forecastdata.list[8].dt, timezone);
    ...
    async function getaqi() {
      ...
      if (aqivalue == 1) {
        document.querySelector(".aqi-value").innerHTML = "Good";
      } else if (aqivalue == 2) {
        document.querySelector(".aqi-value").innerHTML = "Fair";
      } else if (aqivalue == 3) {
        document.querySelector(".aqi-value").innerHTML = "Moderate";
      } else if (aqivalue == 4) {
        document.querySelector(".aqi-value").innerHTML = "Poor";
      } else if (aqivalue == 5) {
        document.querySelector(".aqi-value").innerHTML = "Very Poor";
      }
      searchbox1.value = "";
      searchbox2.value = "";
      searchbox3.value = "";
...
searchbtn1.addEventListener("click", () => {
  getlatlon(searchbox1.value);
});

searchbtn2.addEventListener("click", () => {
  getlatlon(searchbox2.value);
});

searchbtn3.addEventListener("click", () => {
  getlatlon(searchbox3.value);
});
